...
namespace TreeNodes.Test
{
    ...
    public class BinarySearchTree
    {
        ...
        public void Adding_values_to_the_tree_must_set_the_parent_element()
        {
            ...
            Assert.AreEqual(tree.Left.Parent.Value, 4);
            Assert.AreEqual(tree.Left.Left.Parent.Value, 2);
            Assert.AreEqual(tree.Left.Right.Parent.Value, 2);
            Assert.AreEqual(tree.Right.Parent.Value, 4);
            Assert.AreEqual(tree.Right.Right.Parent.Value, 5);
            Assert.AreEqual(tree.Right.Right.Right.Parent.Value, 7);
            Assert.AreEqual(tree.Right.Right.Right.Left.Parent.Value, 10);
        }
    }
}
